...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://129.212.239.12:5174");
        config.addAllowedOrigin("http://129.212.239.12");
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                .authorizeRequests()
                .antMatchers("/login","/company/add_company","/company/forgetPassword","/api/**" ,"/success" ,"/cancel","/api/webhook/stripe","/password/forgotPassword","/actuator/health").permitAll()
