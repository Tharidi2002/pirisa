...
public class CompanyService {
    ...
    public Company updateCompany(Long cmp_id, Company updateCompany) {
        ...
        if (company != null) {
            try {
                if (updateCompany.getCmp_name() != null && !updateCompany.getCmp_name().trim().isEmpty()) {
                    company.setCmp_name(updateCompany.getCmp_name().trim());
                }
                if (updateCompany.getCmp_address() != null) {
                    company.setCmp_address(updateCompany.getCmp_address());
                }
                if (updateCompany.getCmp_phone() != null) {
                    company.setCmp_phone(updateCompany.getCmp_phone());
                }
                if (updateCompany.getCmpEmail() != null && !updateCompany.getCmpEmail().trim().isEmpty()) {
                    company.setCmpEmail(updateCompany.getCmpEmail().trim());
                }
                if (updateCompany.getUsername() != null && !updateCompany.getUsername().trim().isEmpty()) {
                    company.setUsername(updateCompany.getUsername().trim());
                }
                if (updateCompany.getCmp_reg_no() != null && !updateCompany.getCmp_reg_no().trim().isEmpty()) {
                    company.setCmp_reg_no(updateCompany.getCmp_reg_no().trim());
                }
                if (updateCompany.getTin_no() != null && !updateCompany.getTin_no().trim().isEmpty()) {
                    company.setTin_no(updateCompany.getTin_no().trim());
                }
                if (updateCompany.getVat_no() != null && !updateCompany.getVat_no().trim().isEmpty()) {
                    company.setVat_no(updateCompany.getVat_no().trim());
                }
                if (updateCompany.getPackage_name() != null) {
                    company.setPackage_name(updateCompany.getPackage_name());
                }
                if (updateCompany.getCompany_status() != null) {
